"""
Train — FQL: Flow Q-Learning with IQL critic.
python scripts/exp_fql.py  →  sbatch/fql.sh
"""
import os
import sys
import itertools
...
# Per-environment tuned alpha (behavior regularization strength)
ALPHAS = {
    "cube-triple": 1000.0,
    "cube-quadruple": 1000.0,
    "puzzle-4x4": 1000.0,
    "scene": 300.0,
}
